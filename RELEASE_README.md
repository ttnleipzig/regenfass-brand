...
- **PWA:** [kieks-me-pwa-v${VERSION}.zip](https://github.com/kieksme/regenfass.brand/releases/download/v${VERSION}/kieks-me-pwa-v${VERSION}.zip) – Manifest and app icons for Progressive Web Apps
